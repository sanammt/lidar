...
modedata=load("effMaterial_Index_mode1_effMaterial_Data.txt");
...
% %
neff1_modeSolution=modedata(:,2);
neff2_modeSolution=modedata(:,3);
neff3_modeSolution=modedata(:,4);
...
Nrow=length(neff1_modeSolution)

width_modeSolution=modedata(:,6);
meshSize_modeSolution=modedata(:,5);
...
figure('name','neff1_vs_meshSize_Mode_Solution');
set(gcf, 'Position',  [100, 100, 1000, 1000])
plot(meshSize_modeSolution,neff1_modeSolution,'r');
legend('Silicon1 Mode1','location','northwest');
title('neff\_vs\_meshSize\_Mode\_Solution');
xlabel('Mesh Size (micron)');
ylabel('Neff, Propagation Mode Index');

figure('name','neff2_vs_meshSize_Mode_Solution');
set(gcf, 'Position',  [100, 100, 1000, 1000])
plot(meshSize_modeSolution,neff2_modeSolution,'r');
legend('Silicon1 Mode1','location','northwest');
title('neff\_vs\_meshSize\_Mode\_Solution');
xlabel('Mesh Size (micron)');
ylabel('Neff, Propagation Mode Index');

figure('name','neff3_vs_meshSize_Mode_Solution');
set(gcf, 'Position',  [100, 100, 1000, 1000])
plot(meshSize_modeSolution,neff3_modeSolution,'r');
legend('Silicon1 Mode1','location','northwest');
title('neff\_vs\_meshSize\_Mode\_Solution');
xlabel('Mesh Size (micron)');
ylabel('Neff, Propagation Mode Index');
