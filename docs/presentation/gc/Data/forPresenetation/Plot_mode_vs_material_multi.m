...
neff_modeMonitor_fdtd3=fdtddata3(:,2);
neff_modeMonitor_fdtd4=fdtddata4(:,2);
neff_modeMonitor_fdtd5=fdtddata5(:,2);
%
...
Nrow2=min(Nrow1,length(neff_modeMonitor_fdtd3));
Nrow3=min(Nrow2,length(neff_modeMonitor_fdtd4));
Nrow4=min(Nrow3,length(neff_modeMonitor_fdtd5));
Nrow=min(Nrow4,length(neff_modeSolution));
Nrow=22;
